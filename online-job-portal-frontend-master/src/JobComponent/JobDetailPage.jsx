...
const JobDetailPage = () => {
  ...
  const applyForJob = (jobId, e) => {
    ...
    if (employee_jwtToken === null || employee_jwtToken === "") {
      toast.error("Inicie sesión como empleado para solicitar cualquier trabajo.", {
        position: "top-center",
        autoClose: 1000,
      ...
      <div className="col ml-5 mt-3 ms-5 me-5">
            ...
            <div className="col-md-6">
              <div className="card-body">
                ...
                <div className="row mt-4">
                  <div className="col-md-6">
                    <p className="mb-2">
                      <b>Nombres:</b> {job.employer.firstName}
                    </p>
                  </div>
                  <div className="col-md-6">
                    <p className="mb-2">
                      <b>Apellidos:</b> {job.employer.lastName}
                    </p>
                  </div>
                </div>
                <div className="row mt-2">
                  <div className="col-md-6">
                    <p className="mb-2">
                      <b>Correo:</b> {job.employer.emailId}
                    </p>
                  </div>
                  <div className="col-md-6">
                    <p className="mb-2">
                      <b>Contacto:</b> {job.employer.phoneNo}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="row mt-3">
          <div className="col">
            <div className="card rounded-card h-100 shadow-lg">
              <div className="card-body">
                <h3 className="card-title text-color-second">Detalles del Trabajo</h3>
                {/* Row 1 - Job Title */}
                <div className="row mt-4 ms-4 me-4">
                  <div className="col-md-4">
                    <p className="mb-2">
                      <b className="mb-2">Título:</b> {job.title}
                    </p>
                  </div>
                  <div className="col-md-4">
                    <p className="mb-2">
                      <b>Descripcion:</b> {job.description}
                    </p>
                  </div>
                  <div className="col-md-4">
                    <p className="mb-2">
                      <b>Categoria:</b> {job.category.name}
                    </p>
                  </div>
                </div>
                ...
                <div className="row mt-4 ms-4 me-4">
                  <div className="col-md-4">
                    <p className="mb-2">
                      <b>Skills Requeridos:</b> {job.requiredSkills}
                    </p>
                  </div>
                  <div className="col-md-4">
                    <p className="mb-2">
                      <b>Fecha de Publicación:</b> {formatDateFromEpoch(job.datePosted)}
                    </p>
                  </div>
                  <div className="col-md-4">
                    <p className="mb-2">
                      <b>Solicitantes:</b> {job.applicationCount}
                    </p>
                  </div>
                </div>
